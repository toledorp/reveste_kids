...
starshipRoutes.post("/starships", Auth.Authorization, isAdmin, starshipController.createStarship)

// Endpoint para deletar um veículo
starshipRoutes.delete("/starships/:id", Auth.Authorization, isAdmin, starshipController.deleteStarship)

// Endpoint para atualizar um veículo
starshipRoutes.put("/starships/:id", Auth.Authorization, isAdmin, starshipController.updateStarship)
